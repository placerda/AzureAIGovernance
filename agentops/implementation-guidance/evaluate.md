...
lab](../workshop/labs/01-evaluate/lab.md). Its main path is the released Accelerator
...
Its [tooling decision](../workshop/labs/01-evaluate/TOOLING.md) defines the narrow
